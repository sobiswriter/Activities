...
export function ActivityCard({ title, description, icon, color, textColor }: ActivityCardProps) {
  return (
    <Card className="h-full cursor-pointer transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl hover:border-primary/50 flex flex-col">
